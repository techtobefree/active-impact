...
python -m pytest -q                   # 415 tests: auth, ledger invariants, event matching, locations, social, all domains
...
| [`docs/design/SOCIAL.md`](docs/design/SOCIAL.md) | Following people, their activity, blocking that keeps the follower, and notifications derived from a watermark |
| [`docs/design/PUSH.md`](docs/design/PUSH.md) | Web Push — notifications on the phone with the app closed, self-minted VAPID keys, and the iOS "must be installed" reality |
